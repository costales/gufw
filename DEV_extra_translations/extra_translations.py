...
if __name__ == "__main__":
    ...
    print(_("Tvheadend"))
    print(_("TV streaming server and digital video recorder"))
    print(_("Media;Multimedia;Network;Streaming;TV;"))
    print(_("Murmur"))
    ...
    print(_("Parsec"))
    print(_("A desktop capturing application primarily used for playing games through video streaming. "))
    print(_("Games"))
    print(_("Wormux"))
    ...
    print(_("KODI Remote"))
    print(_("Remote control for KODI"))
    ...
    print(_("Syncthing Sync"))
    print(_("Syncthing UDP/TCP based sync protocol traffic (default port)"))
    print(_("Network;File Transfer;"))
    print(_("Syncthing Local Discovery"))
    print(_("Syncthing discovery broadcasts on IPv4 and multicasts on IPv6 (default port)"))
    print(_("LPD"))
    print(_("LPD server"))
    print(_("ChromeCast"))
    ...
    print(_("Remember to open the ports on the router"))
    print(_("Rygel"))
    print(_("Easier media sharing between Ubuntu and smart TVs, games consoles, and even other computers"))
    print(_("Diablo II"))
    print(_("Fantasy combat game by Blizzard Entertainment"))
    ...
    print(_("SMPlayer to ChromeCast"))
    print(_("Stream SMPlayer to ChromeCast"))
